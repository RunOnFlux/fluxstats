...
module.exports = (server) => {
  describe('Flux UI Endpoints Test', () => {
    it('Should receive status 200 on /fluxinfo?projection=ip,tier,geolocation,benchmark,node,flux and return 0 when server is running', (done) => {
      request(server)
    ...
    it('Should receive status 200 on /fluxinfo?projection=node,flux,appsHashesTotal and return 0 when server is running', (done) => {
      request(server)
    ...
    it('Should receive status 200 on /fluxinfo?projection=node,flux,geolocation,tier and return 0 when server is running', (done) => {
      request(server)
    ...
    it('Should receive status 200 on /fluxinfo?projection=ip,apps and return 0 when server is running', (done) => {
      request(server)
    ...
    it('Should receive status 200 on /fluxinfo?projection=ip,collateralIndex,collateralHash,appsHashesTotal,hashesPresent,addedHeight,lastPaidHeight,confirmedHeight,lastConfirmedHeight,scannedHeight and return 0 when server is running', (done) => {
      request(server)
    ...
    it('Should receive status 200 on /fluxinfo?projection=ip,connectionsOut,connectionsIn and return 0 when server is running', (done) => {
      request(server)
    ...
    it('Should receive status 200 on /fluxinfo?projection=ip,geolocation and return 0 when server is running', (done) => {
      request(server)
    ...
    it('Should receive status 200 on /fluxinfo?projection=ip,activeSince,dataCollectedAt and return 0 when server is running', (done) => {
      request(server)
    ...
    it('Should receive status 200 on /fluxinfo?projection=ip,daemon,benchmark,flux and return 0 when server is running', (done) => {
      request(server)

<template>
  <div>
    ...
    <p class="category">
      ...
      >Tristan Edwards</a>. Please check out the <a
    ...
    <p class="category">
      Highly customizable modal components. Please check out the <a
...
import Vue from 'vue';
import {
  Dialog, Table, TableColumn, MessageBox,
} from 'element-ui';
